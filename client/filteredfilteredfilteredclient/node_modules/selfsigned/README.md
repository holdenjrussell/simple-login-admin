...
> You can avoid key pair generation specifying your own keys (`{ keyPair: { publicKey: '-----BEGIN REMOVED_PUBLIC_KEY-----...', privateKey: '-----BEGIN RSA REMOVED_PRIVATE_KEY-----...' }`)
