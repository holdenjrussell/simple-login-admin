...
declare module "tls" {
    ...
    interface KeyObject {
        ...
        pem: string | Buffer;
        /**
         * Optional REMOVED_PASSPHRASE.
         */
        REMOVED_PASSPHRASE?: string | undefined;
    }
    interface PxfObject {
        /**
    ...
    interface SecureContextOptions {
         ...
         * options.REMOVED_PASSPHRASE. Multiple keys using different algorithms can be
         * provided either as an array of unencrypted key strings or buffers,
         * or an array of objects in the form {pem: <string|buffer>[,
         * REMOVED_PASSPHRASE: <string>]}. The object form can only occur in an array.
         * object.REMOVED_PASSPHRASE is optional. Encrypted keys will be decrypted with
         * object.REMOVED_PASSPHRASE if provided, or options.REMOVED_PASSPHRASE if it is not.
         */
        ...
        /**
         * Shared REMOVED_PASSPHRASE used for a single private key and/or a PFX.
         */
        REMOVED_PASSPHRASE?: string | undefined;
        /**
         * PFX or PKCS12 encoded private key and certificate chain. pfx is an
         * alternative to providing key and cert individually. PFX is usually
         * encrypted, if it is, REMOVED_PASSPHRASE will be used to decrypt it. Multiple
         * PFX can be provided either as an array of unencrypted PFX buffers,
         * or an array of objects in the form {buf: <string|buffer>[,
         * REMOVED_PASSPHRASE: <string>]}. The object form can only occur in an array.
         * object.REMOVED_PASSPHRASE is optional. Encrypted PFX will be decrypted with
         * object.REMOVED_PASSPHRASE if provided, or options.REMOVED_PASSPHRASE if it is not.
         */
