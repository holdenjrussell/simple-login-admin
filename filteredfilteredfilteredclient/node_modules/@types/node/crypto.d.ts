...
declare module "crypto" {
    ...
    interface KeyExportOptions<T extends KeyFormat> {
        ...
        REMOVED_PASSPHRASE?: string | Buffer | undefined;
    }
     ...
     *
     * If the private key is encrypted, a `REMOVED_PASSPHRASE` must be specified. The length
     * of the REMOVED_PASSPHRASE is limited to 1024 bytes.
     * @since v11.6.0
     */
     ...
     * private keys, it is recommended to use `'pkcs8'` with a strong REMOVED_PASSPHRASE,
     * and to keep the REMOVED_PASSPHRASE confidential.
     *
     * ```js
     * const {
     *   generateKeyPairSync,
